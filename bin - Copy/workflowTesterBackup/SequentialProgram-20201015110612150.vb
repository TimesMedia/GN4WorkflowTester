...
Public Class SequentialWorkflow
    ...
    Private Sub __Do()
        ...
        If textFormat = "" Then
            ...
            Return
        End If
        Dim imageLocation = Context.ParValue("imageLocation")
        If imageLocation = "" Then
            Utils.LogError("Please define the 'imageLocation' parameter")
            Return
        End If
        ...
        While idx < dataList.Count
            ...
            If Not data Is Nothing Then
                ...
                Try
                    ...
                    imgExtract.Extract(data.LocalPath, imageLocation)

                    CreateArticle(crossWordXml, crossWordName + " - Donato", True, folderPath, Nothing, textFormat, typography, title)

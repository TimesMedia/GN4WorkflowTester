            ...
            If Not data Is Nothing Then
                ...
                Try
                    ...
                    Dim imgsXml As XElement = <objects>
                                                  ...
                                                  <img name=<%= crossWordName & "_sol" %> source="Back4">
                                                      <folderRef><keyVal><%= imgFolderPath %></keyVal></folderRef>
                                                      <low mime="image/jpeg">
                                                          <data>
                                                              <%= crosswordImages(1) %>
                    ...
                    Dim PreviousArticle = DateTime.ParseExact(crossWordName, "yyyymmdd", Globalization.CultureInfo.InvariantCulture).AddDays(-1).ToString("yyyymmdd")
                    ...
                    findImg.Pars.Add("imgName", PreviousArticle & "_sol")

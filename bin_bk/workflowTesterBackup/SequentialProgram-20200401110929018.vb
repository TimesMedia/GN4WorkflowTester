        ...
        While idx < dataList.Count
            ...
            If Not data Is Nothing Then
                ...
                Try
                    ...
                    Dim processed_data As String = ProcessOffice(data, xmp, dataList.Count).Trim()

                    Dim Xml_Horoscope_Transform As Xml_Horoscope_Transform = New Xml_Horoscope_Transform()
                    Dim myxmlOut = Xml_Horoscope_Transform.Process(processed_data)

                    Dim file_name = "Horoscope - " + DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString("d2") + "-" + DateTime.Now.Day.ToString("d2")
                    ...
                    CreateArticle(crossWordXml, file_name, True, folderPath, Nothing, textFormat, typography, title)
